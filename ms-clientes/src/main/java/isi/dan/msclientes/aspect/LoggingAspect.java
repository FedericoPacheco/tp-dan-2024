...
public class LoggingAspect {
    ...
    /* 
        *                       -> cualquier retorno
        isi.dan.msclientes..    -> cualquier subpaquete de isi.dan.ms.pedidos 
        *                       -> cualquier clase
        .*                      -> cualquier metodo
        (..)                    -> cualquier cantidad y tipo de argumentos
     */
    @Pointcut("execution(* isi.dan.msclientes..*.*(..))")
    public void allMethods() {}

    @Pointcut("execution(public * isi.dan.msclientes.controller.*.*(..))")
    public void controllerMethods() {}

    @Pointcut("execution(public * isi.dan.msclientes.service.*.*(..))")
