    ...
    <form action={formAction} className="space-y-3">
      <div className="flex-1 rounded-lg bg-ebony-400 px-6 pb-4 pt-8">
        <div className="w-full">
            <div>
                <label className="mb-3 mt-5 block text-xs font-medium text-white-50" htmlFor="name">
                    Nombre
                </label>
            ...
            <div>
                <label className="mb-3 mt-5 block text-xs font-medium text-white-50" htmlFor="cuit">
                    CUIT
                </label>
                <div className="relative">
                    <input
            ...
            <div>
                <label className="mb-3 mt-5 block text-xs font-medium text-white-50" htmlFor="email">
                    Email
                </label>
                <div className="relative">
                    <input
            ...
            <div className="mt-4">
                <label className="mb-3 mt-5 block text-xs font-medium text-white-50" htmlFor="password">
                    Contraseña
                </label>
                <div className="relative">
                    <input
                        ...
                        type="password"
                        name="password"
                        placeholder="Contraseña de usuario administrador"
                        required
                        minLength={6}
                    />
        ...
        <div className='flex items-center justify-center'>    
            <Button type="submit" className="mt-4 mx-2 w-full md:w-1/2 bg-white-50 hover:bg-white-800">
