...
public class LoggingAspect {
    ...
    /* 
        *                       -> cualquier retorno
        isi.dan.ms_productos..  -> cualquier subpaquete de isi.dan.ms.pedidos 
        *                       -> cualquier clase
        .*                      -> cualquier metodo
        (..)                    -> cualquier cantidad y tipo de argumentos
     */
    @Pointcut("execution(* isi.dan.ms_productos..*.*(..))")
    public void allMethods() {}

    @Pointcut("execution(public * isi.dan.ms_productos.controller.*.*(..))")
    public void controllerMethods() {}

    @Pointcut("execution(public * isi.dan.ms_productos.service.*.*(..))")
